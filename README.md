...
**Enumerables is a ruby project where we defined ourselves the functionality of three enumerable methods in ruby. They are all , any and filter.**
...
### Usage
1. Install Ruby
2. Clone this repo `git clone https://github.com/Botlhale-Setou/Enumerables.git`
...
Feel free to check the [issues page](https://github.com/Botlhale-Setou/Enumerables/issues).
